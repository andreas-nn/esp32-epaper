//project Waveshare32 with 7.5 inch epd.h
//in portrait-modus
...
//hardware-definition waveshare32
...
#define EPD_PWR 4                      // only Waveshare EPD-Hat need a High-Level at PWR (9 Pin Cable)
#define EPD_BATTERY 35                 // measure battery voltage

#define EPD_BAT_DIVIDER 5890           // Divider for calculation of battery voltage

#define EPD_SLEEP   3600               // standard-time for deepsleep, if not changed by webserver
#define EPD_Rotation 1                 // selection between landscape and portrait-mode

//define display
#define GxEPD2_DISPLAY_CLASS GxEPD2_BW
#define GxEPD2_DRIVER_CLASS GxEPD2_750_T7 // GDEY0213Z98c 122x250, SSD1680
